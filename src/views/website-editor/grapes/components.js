...
export function registerComponents(editor) {
  editor.DomComponents.addType("website-header", sectionComponent("website-header", `
    <div class="site-container site-header__inner" style="display:flex;align-items:center;justify-content:space-between;gap:24px;">
      <strong class="js-title" data-field="js-title" style="font-size:22px;color:#0f172a;">企业品牌</strong>
      <nav class="site-header__nav" style="display:flex;gap:22px;color:#475569;font-weight:600;">
        <a>首页</a><a>产品</a><a>案例</a><a>新闻</a><a>联系</a>
      </nav>
      <a class="site-button js-button" data-field="js-button">立即咨询</a>
    </div>
  `));
  ...
  editor.DomComponents.addType("website-banner", sectionComponent("website-banner", `
    <div class="site-container site-banner__inner" style="display:grid;grid-template-columns:1.05fr .95fr;align-items:center;gap:42px;min-height:520px;">
      <div>
        ...
        <h1 class="site-title js-title" data-field="js-title" style="font-size:54px;">科技改变未来</h1>
        <p class="site-subtitle js-subtitle" data-field="js-subtitle">用专业产品与服务，为企业打造稳定、高效、可持续增长的数字化官网。</p>
        <a class="site-button js-button" data-field="js-button" style="margin-top:26px;">了解方案</a>
      </div>
  ...
  editor.DomComponents.addType("website-about", sectionComponent("website-about", `
    <div class="site-container site-about__inner" style="display:grid;grid-template-columns:.9fr 1.1fr;gap:38px;align-items:center;">
      ...
      <div>
        ...
        <h2 class="site-title js-title" data-field="js-title">关于我们</h2>
        <p class="site-subtitle js-subtitle" data-field="js-subtitle">我们专注于企业数字化建设，提供官网、业务系统和品牌增长的一体化解决方案。</p>
      </div>
    </div>
  `));
  ...
  editor.DomComponents.addType("website-products", sectionComponent("website-products", `
    <div class="site-container">
      ...
      <h2 class="site-title js-title" data-field="js-title">产品列表</h2>
      <p class="site-subtitle js-subtitle" data-field="js-subtitle">展示核心产品能力，帮助客户快速理解价值。</p>
      <div class="site-grid">
  ...
  editor.DomComponents.addType("website-services", sectionComponent("website-services", `
    <div class="site-container">
      ...
      <h2 class="site-title js-title" data-field="js-title">服务优势</h2>
      <p class="site-subtitle js-subtitle" data-field="js-subtitle">从咨询、设计、开发到交付，提供完整服务链路。</p>
      <div class="site-grid">
  ...
  editor.DomComponents.addType("website-cases", sectionComponent("website-cases", `
    <div class="site-container">
      ...
      <h2 class="site-title js-title" data-field="js-title">案例展示</h2>
      <p class="site-subtitle js-subtitle" data-field="js-subtitle">沉淀行业经验，为客户提供可复制的成功路径。</p>
      <div class="site-grid">
  ...
  editor.DomComponents.addType("website-news", sectionComponent("website-news", `
    <div class="site-container">
      ...
      <h2 class="site-title js-title" data-field="js-title">新闻列表</h2>
      <p class="site-subtitle js-subtitle" data-field="js-subtitle">发布企业动态、行业观点和产品更新。</p>
      <div class="site-grid">
  ...
  editor.DomComponents.addType("website-testimonials", sectionComponent("website-testimonials", `
    <div class="site-container">
      ...
      <h2 class="site-title js-title" data-field="js-title">客户评价</h2>
      <p class="site-subtitle js-subtitle" data-field="js-subtitle">真实反馈建立信任，让潜在客户更快做出决策。</p>
      <div class="site-grid">
  ...
  editor.DomComponents.addType("website-contact", sectionComponent("website-contact", `
    <div class="site-container site-contact__inner" style="display:grid;grid-template-columns:1fr 1fr;gap:28px;">
      <div>
        ...
        <h2 class="site-title js-title" data-field="js-title">联系我们</h2>
        <p class="site-subtitle js-subtitle" data-field="js-subtitle" >留下需求，我们会尽快安排顾问与您沟通。</p>
      </div>
  ...
  editor.DomComponents.addType("website-footer", sectionComponent("website-footer", `
    <div class="site-container" style="display:flex;justify-content:space-between;gap:18px;flex-wrap:wrap;">
      <div>
        <strong class="js-title" data-field="js-title" style="font-size:20px;color:#fff;">企业品牌</strong>
        <p class="js-subtitle" data-field="js-subtitle" style="margin:10px 0 0;color:#cbd5e1;">专注企业数字化官网建设</p>
      </div>
